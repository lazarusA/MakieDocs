...
We can use those events to e.g. move the subwindow. If you execute the below in GLMakie, you can move the sub-window around by pressing left mouse and ctrl:
...
```
 ...
 <video src="/lego_walk.mp4" controls="controls" autoplay="autoplay"></video>
